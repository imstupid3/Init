...
function library:CreateWindow(name, size, hidebutton)
    ...
    window.name = name or ""
    window.size = UDim2.fromOffset(size.X + 50, size.Y) or UDim2.fromOffset(300, 325)
    ...
    window.Frame = utility:Create("ImageLabel", {
		Name = "Frame",
		Size = window.size,
    ...
    window.Topbar = utility:Create("ImageLabel", {
		Name = "Topbar",
		Size = UDim2.fromOffset(window.size.X.Offset,26),
		ImageTransparency = 1,
    ...
    window.NameLabel = utility:Create("TextLabel", {
	    TextColor3 = window.theme.toptextcolor,
	    Text = window.name,
    ...
    window.Line2 = utility:Create("ImageLabel", {
	    Name = "line",
	    Position = UDim2.fromOffset(0, window.Topbar.AbsoluteSize.Y - 1),
	    Size = UDim2.fromOffset(window.size.X.Offset, 1),
	    BorderSizePixel = 0,
	    BackgroundColor3 = window.theme.accentcolor,
	    Parent = window.Topbar
	})

    window.TabList = utility:Create("ImageLabel", {
	    Name = "tablist",
	    BackgroundTransparency = 1,
    ...
    window.BackgroundImage.Position = UDim2.fromOffset(0, 49)
    window.BackgroundImage.Size = UDim2.fromOffset(window.size.X.Offset, window.size.Y.Offset - window.Topbar.AbsoluteSize.Y - window.TabList.AbsoluteSize.Y - 1)
    ...
    function window:CreateTab(name)
        ...
        tab.Left.Position = UDim2.fromOffset(0, 1)
        ...
        function tab:SelectTab()
            ...
            window.Line:TweenSizeAndPosition(UDim2.fromOffset(size.X + 15, 1),UDim2.new(0, (tab.TabButton.AbsolutePosition.X - window.Frame.AbsolutePosition.X), 0, 48),Enum.EasingDirection.In,Enum.EasingStyle.Sine,0.15)
            wait(0.2)
            block = false
        end
